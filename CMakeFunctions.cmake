...
function(get_version_from_git)
  if (EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.git" AND IS_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}/.git")
    ...
    execute_process(COMMAND ${GIT_EXECUTABLE} log -1 --pretty='%cd' --date=format:'%Y%m%d' OUTPUT_VARIABLE VERSION1)
    execute_process(COMMAND ${GIT_EXECUTABLE} describe --dirty --always OUTPUT_VARIABLE VERSION2)
    string(STRIP ${VERSION1} VERSION1)
    string(REPLACE "'" "" VERSION1 ${VERSION1})  # remove that strange ticks
    string(STRIP ${VERSION2} VERSION2)
    set (VERSION "${VERSION1}-${VERSION2}" PARENT_SCOPE)
  endif ()
endfunction()
